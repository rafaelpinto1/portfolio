...
(function (root) {
    ...
    const I18N_DICT = {
        pt: {
            ...
            'hero.bio1': 'Especialista em Dados, Backend & IA Generativa. Trabalho com <strong>Node.js</strong>, <strong>Python</strong>, <strong>Azure Functions</strong>, <strong>PostgreSQL</strong> e <strong>Microsoft Fabric</strong> para construir pipelines de dados eficientes e modelos de IA em produção.',
            ...
            'hero.bio3': 'Meu posicionamento é a interseção backend + dados + IA: engenheiro full-stack na era da IA generativa, não apenas data scientist.',
            ...
            'research.body': 'Minha pesquisa em TinyML investiga como comprimir e otimizar modelos de Machine Learning para rodar em hardware extremamente limitado — microcontroladores com poucos kilobytes de RAM e sensores IoT sem GPU, sem nuvem, com mínimo consumo de energia. Não é hobby acadêmico: é a mesma disciplina de eficiência que aplico no mercado todos os dias. Em produção, enfrentei problemas reais de custo (reduzir tokens em chamadas a LLMs), latência (processar embeddings rapidamente) e escalabilidade (rodar modelos com poucos recursos). TinyML oferece técnicas comprovadas de otimização que bridgeiam esse gap.',
            ...
            'exp1.b6': 'Integração de dados corporativos de <strong>SQL Server</strong>, <strong>Oracle</strong>, <strong>SharePoint</strong>, gateways de pagamento (<strong>ContaAzul</strong>, <strong>MercadoPago</strong>, <strong>PagSeguro</strong>) e outras fontes.',
            ...
            'exp1.b8': 'Colaboração em monorepo <strong>Dashpress/D.AI</strong> com 4 subprojetos paralelos para múltiplos clientes em setores de varejo, serviços e tecnologia.',
        ...
        en: {
            ...
            'hero.bio1': 'Specialist in Data, Backend & Generative AI. I work with <strong>Node.js</strong>, <strong>Python</strong>, <strong>Azure Functions</strong>, <strong>PostgreSQL</strong>, and <strong>Microsoft Fabric</strong> to build efficient data pipelines and production AI models.',
            'hero.bio2': 'M.Sc. student in Computer Science researching <strong>TinyML</strong> at CEFET/RJ — investigating efficiency in constrained hardware. This research connects directly to my production work: optimizing cost, latency, and resource consumption in data and AI systems.',
            'hero.bio3': 'My positioning is at the intersection of backend + data + AI: full-stack engineer in the age of generative AI, not just a data scientist.',
            ...
            'research.body': 'My research in TinyML investigates how to compress and optimize ML models to run on extremely constrained hardware — microcontrollers with just kilobytes of RAM, IoT sensors without GPU, cloud, or battery power. This isn\'t academic isolation: it\'s the exact discipline of efficiency I apply daily in production. I face real problems: cutting token costs on LLM calls, processing embeddings fast, scaling models with minimal resources. TinyML provides proven optimization techniques that bridge that gap between lab and production.',
            'research.tag1': 'TinyML',
            ...
            'exp1.b6': 'Integrated corporate data from <strong>SQL Server</strong>, <strong>Oracle</strong>, <strong>SharePoint</strong>, payment gateways (<strong>ContaAzul</strong>, <strong>MercadoPago</strong>, <strong>PagSeguro</strong>), and other sources.',
            ...
            'exp1.b8': 'Worked in <strong>Dashpress/D.AI</strong> monorepo with 4 parallel sub-projects serving multiple clients across retail, services, and tech sectors.',
